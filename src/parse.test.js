...
describe('get-schema', function () {
    ...
    it('handles custom file path', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expect.assertions(1);
                    return [4 /*yield*/, parseSchema('./node_modules/@open-rpc/examples/service-descriptions/petstore.json')];
                case 1:
                    schema = _a.sent();
    ...
    it('handles urls', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, parseSchema('https://raw.githubusercontent.com/open-rpc/examples/master/service-descriptions/petstore.json')];
                case 1:
                    schema = _a.sent();
                    expect(schema.methods).toBeDefined();
                    return [2 /*return*/];
    ...
    it('handles json as string', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, parseSchema(JSON.stringify({ methods: { foo: {} } }))];
                case 1:
                    schema = _a.sent();
                    expect(schema.methods).toBeDefined();
                    return [2 /*return*/];
